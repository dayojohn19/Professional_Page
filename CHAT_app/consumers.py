    ...
    def connect(self):
        ...
        for i in self.chatRoom.messages_items:
            self.send(text_data=json.dumps({
                ...
                'message_timestamp':datetime.fromisoformat(str(i.message_timestamp)).strftime("%I:%M %p %d%b%Y")
    ...
    def chat_message(self,event):
        ...
        try:
            ...
            self.send(text_data=json.dumps({
                ...
                'message_timestamp': datetime.fromisoformat(str(new_chat_message.message_timestamp)).strftime("%I:%M %p %d%b%Y")
            },default=str,sort_keys=True))
